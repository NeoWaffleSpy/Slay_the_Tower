...
public class HomingMissileComponent implements Component<EntityStore> {
    ...
    public HomingMissileComponent(double px, double py, double pz, double vx, double vy, double vz, Ref<EntityStore> ownerRef, float damage) {
        this.px = px;
        this.py = py;
        this.pz = pz;
        this.vx = vx;
    ...
    public @Nullable Component<EntityStore> clone() {
        HomingMissileComponent copy = new HomingMissileComponent(px, py, pz, vx, vy, vz, ownerRef, damage);
