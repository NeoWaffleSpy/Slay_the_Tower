        ...
        if (event.getMouseButton().state == MouseButtonState.Pressed) {
            ...
            if (event.getItemInHand() != null && event.getItemInHand().hasBlockType() && targetBlock != null) {
                ...
                if (!lastTargetBlock.equals(targetBlock)) {
                    BlockIterator.iterateFromTo((double) lastTargetBlock.x(), (double) (lastTargetBlock.y() + 1), (double) lastTargetBlock.z(), (double) targetBlock.x(), (double) (targetBlock.y() + 1), (double) targetBlock.z(), (xx, y, zx, px, py, pz, qx, qy, qz) -> {
