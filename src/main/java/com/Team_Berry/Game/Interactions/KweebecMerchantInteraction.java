...
public class KweebecMerchantInteraction extends SimpleInstantInteraction {

    public static final BuilderCodec<KweebecMerchantInteraction> CODEC = BuilderCodec.builder(KweebecMerchantInteraction.class, KweebecMerchantInteraction::new, SimpleInstantInteraction.CODEC).build();
    ...
    protected void firstRun(@NotNull InteractionType interactionType, @NotNull InteractionContext interactionContext, @NotNull CooldownHandler cooldownHandler) {
        ...
        if (manager != null) {
            manager.kweebecMerchantInteraction(playerRef);
        }
    }
}