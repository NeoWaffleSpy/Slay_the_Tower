...
public class BreakBlockProtectionSystem extends EntityEventSystem<EntityStore, BreakBlockEvent> {

    public BreakBlockProtectionSystem(@NotNull Class<BreakBlockEvent> eventType) {
        super(eventType);
    }
